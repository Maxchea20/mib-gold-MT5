  ...
  return (
    <div className="flex-1 flex min-h-0">
      <div className="w-[280px] shrink-0 border-r border-[var(--hair)] overflow-y-auto">
        ...
        <div className="px-3 pt-2 text-[9px] mono text-mute">Best LIQ so far = M3 close-through</div>
        ...
        <div className="px-3 pb-3 flex flex-col gap-2">
          <button className={`btn active w-full ${running ? "breathe" : ""}`} onClick={() => run("liq_join_m3")} disabled={!!running}>
            {running && form.book === "liq_join_m3" ? `running ${pctRun.toFixed(0)}%` : "run LIQ-JOIN M3 (best)"}
          </button>
